          ...
          <div className="space-y-6 sm:space-y-8 mb-8">
            ...
            >
              ...
              <div className="space-y-3 text-sm sm:text-base text-gray-700">
                <p><strong className="text-gray-900">Acceptance of Terms:</strong> By using NCERT SmartTest, you agree to be bound by these Terms of Service.</p>
                <p><strong className="text-gray-900">Service Description:</strong> NCERT SmartTest provides AI-generated MCQ tests for educational purposes based on NCERT curriculum.</p>
                ...
                <p><strong className="text-gray-900">Limitation of Liability:</strong> NCERT SmartTest is provided "as is" without warranties of any kind. We are not liable for any indirect, incidental, or consequential damages.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-3 text-sm sm:text-base text-gray-700">
                <p><strong className="text-gray-900">Content Ownership:</strong> All content on NCERT SmartTest, including but not limited to text, graphics, logos, and software, is the property of NCERT SmartTest or its content suppliers.</p>
            ...
            >
              ...
              <div className="space-y-3 text-sm sm:text-base text-gray-700">
                <p><strong className="text-gray-900">Educational Use:</strong> NCERT SmartTest is provided for educational and practice purposes only. Results are not official exam scores or certifications.</p>
